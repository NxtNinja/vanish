    ...
    <>
          ...
          <div className="flex flex-col items-center text-center space-y-10">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-2xl mx-auto text-zinc-500 text-lg md:text-xl leading-relaxed font-medium animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-300">
                The most private way to communicate. No logs, no tracking, and 
                automatic self-destruction. Your privacy is our only protocol.
              </p>
            </div>
        ...
        <section className="max-w-7xl mx-auto px-6 py-32 relative">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-1px bg-zinc-800/50 border border-zinc-800/50">
            ...
            <div className="bg-[#030303] p-12 space-y-6 group hover:bg-zinc-900/30 transition-colors">
              <div className="w-12 h-12 flex items-center justify-center bg-zinc-900 border border-zinc-800 group-hover:border-green-500/50 transition-all duration-500">
                <EyeOff className="text-green-500" size={24} />
              </div>
              <div className="space-y-2">
                <h3 className="text-xl font-bold text-white tracking-tight">Anonymous ID</h3>
                <p className="text-zinc-500 text-sm leading-relaxed">
                  No accounts required. Every session generates a unique, randomized identity that exists only for that room.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex-1 space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-zinc-500 text-lg leading-relaxed">
                  Vanish is engineered with a focus on ephemeral data. Our infrastructure 
                  is designed to forget, not to remember. Every message is a ghost.
                </p>
              </div>
              <div className="grid grid-cols-2 gap-8">
                <div className="space-y-2">
                  <div className="text-white font-bold text-sm uppercase tracking-widest">Redis Backed</div>
                  <div className="text-zinc-600 text-xs">High-speed, in-memory data management for instant purging.</div>
                </div>
                <div className="space-y-2">
                  <div className="text-white font-bold text-sm uppercase tracking-widest">Real-time</div>
                  <div className="text-zinc-600 text-xs">Powered by Upstash Realtime for seamless, secure communication.</div>
                </div>
              </div>
            </div>
